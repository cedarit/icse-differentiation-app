...
/**
 * Topic 11: Chain Rule — Composite Functions
 * Textbook reference: XII §8.3, Ex 8(A)
 * 
 ...
 *
 * See CLAUDE.md → "Topic 11" for full spec.
    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 24 }}>
      ...
      {tab === 'watch' && (
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: 32, textAlign: 'center' }}>
          ...
          <div style={{ color: '#94a3b8', fontSize: 15 }}>
            Animation for <strong style={{ color: '#e2e8f0' }}>Topic 11: Chain Rule — Composite Functions</strong> coming soon.
          </div>
      ...
      {tab === 'try' && (
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: 32, textAlign: 'center' }}>
          <div style={{ fontSize: 48, marginBottom: 16 }}>🎮</div>
          <div style={{ color: '#94a3b8', fontSize: 15 }}>
            Interactive playground for <strong style={{ color: '#e2e8f0' }}>Topic 11</strong> coming soon.
          </div>
        </div>
      )}
      ...
      {tab === 'exercises' && (
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: 32, textAlign: 'center' }}>
          <div style={{ fontSize: 48, marginBottom: 16 }}>📝</div>
          <div style={{ color: '#94a3b8', fontSize: 15 }}>
            Exercises from <strong style={{ color: '#e2e8f0' }}>{'XII §8.3, Ex 8(A)'}</strong> coming soon.
          </div>
        </div>
      )}
    </div>
