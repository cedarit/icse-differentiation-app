 ...
 * Textbook reference: XII §8.6, Ex 8(A) #17-21
 * 
 ...
 *
 * See CLAUDE.md → "Topic 12" for full spec.
    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 24 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ fontSize: 11, color: '#f472b6', fontWeight: 700, textTransform: 'uppercase', letterSpacing: 2, marginBottom: 6 }}>
          Topic 12 · XII §8.6, Ex 8(A) #17-21
        </div>
        <h1 style={{ margin: 0, fontSize: 28, color: '#e2e8f0', fontWeight: 700 }}>
          Chain Rule with Trig (Extended)
        </h1>
      </div>
      ...
      {tab === 'watch' && (
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: 32, textAlign: 'center' }}>
          ...
          <div style={{ color: '#94a3b8', fontSize: 15 }}>
            Animation for <strong style={{ color: '#e2e8f0' }}>Topic 12: Chain Rule with Trig (Extended)</strong> coming soon.
          </div>
      ...
      {tab === 'try' && (
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: 32, textAlign: 'center' }}>
          <div style={{ fontSize: 48, marginBottom: 16 }}>🎮</div>
          <div style={{ color: '#94a3b8', fontSize: 15 }}>
            Interactive playground for <strong style={{ color: '#e2e8f0' }}>Topic 12</strong> coming soon.
          </div>
        </div>
      )}
      ...
      {tab === 'exercises' && (
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 14, padding: 32, textAlign: 'center' }}>
          <div style={{ fontSize: 48, marginBottom: 16 }}>📝</div>
          <div style={{ color: '#94a3b8', fontSize: 15 }}>
            Exercises from <strong style={{ color: '#e2e8f0' }}>{'XII §8.6, Ex 8(A) #17-21'}</strong> coming soon.
          </div>
        </div>
      )}
    </div>
